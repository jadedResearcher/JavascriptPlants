...
function HalloweenBranch(x,y,maxx,maxy, parent) {
	...
	this.sprout_branch = function(branch_list, branch_sprite_list){
		if(((Math.random() * 90 + this.distance_from_seed * 2) < 30) || this.parent.seed){
			branch = new HalloweenBranch(this.endx,this.endy,this.max_x,this.max_y, this);
